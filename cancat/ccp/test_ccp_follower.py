...
class TestCcpFollowerMessageParsing(unittest.TestCase):
    ...
    def test_parse_connect_CRO(self):
        ...
        received_CRO = bytes('\x01\x20\x33\x03\x90\x90\x90\x90')
    ...
    def test_parse_exchangeID_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x17\x21\x90\x90\x90\x90\x90\x90')
        expected = {'CMD': 0x17, 'CTR': 0x21 }
        parsed = ccp._parse_exchangeID_CRO(received_CRO)
        self.assertEqual(parsed, expected)

    def test_parse_set_MTA_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x02\x22\x00\x02\x12\x34\x56\x78')
    ...
    def test_parse_download_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x03\x23\x04\xde\xad\xbe\xef\x90')
    ...
    def test_parse_upload_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x04\x24\x05\x90\x90\x90\x90\x90')
    ...
    def test_parse_disconnect_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x07\x25\x01\x90\x44\x04\x90\x90')
    ...
    def test_parse_program_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x18\x26\x04\xde\xad\xbe\xef\x90')
    ...
    def test_parse_move_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x19\x27\x00\x00\x80\x00\x90\x90')
    ...
    def test_parse_clear_memory_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x10\x28\x00\x00\x80\x00\x90\x90')
    ...
    def testrunner_leader_parse_test_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x05\x29\x55\x05\x90\x90\x90\x90')
    ...
    def test_parse_get_ccp_version_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x1b\x30\x02\x01\x90\x90\x90\x90')
    ...
    def test_parse_get_seed_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x12\x31\x02\x90\x90\x90\x90\x90')
        expected = {'CMD': 0x12, 'CTR': 0x31, 'requested_resource': 2 }
        parsed = ccp._parse_get_seed_CRO(received_CRO)
        self.assertEqual(parsed, expected)

    def testparse_unlock_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x13\x32\x4e\xee\xee\xee\xee\xe7')
    ...
    def test_parse_build_chksum_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x0e\x33\x00\x00\x80\x00\x90\x90')
    ...
    def test_parse_short_upload_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x0f\x34\x04\x02\x12\x34\x56\x78')
    ...
    def test_parse_get_s_status_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x0c\x35\x90\x90\x90\x90\x90\x90')
    ...
    def test_parse_set_s_status_CRO(self):
        ccp = CCPFollower(c=None)
        received_CRO = bytes('\x0d\x36\x03\x90\x90\x90\x90\x90')
...
class TestCCPFollowerMessageGeneration(unittest.TestCase):
    ...
    def test_generate_connect_CRM(self):
        ...
        expected = bytes('\xff\x00\x70\x90\x90\x90\x90\x90')
    ...
    def test_generate_disconnect_CRM(self):
        ...
        expected = bytes('\xff\x33\x71\x90\x90\x90\x90\x90')
        self.assertEqual(msg, expected)
    ...
    def test_generate_setMTA_CRM(self):
        ...
        expected = bytes('\xff\x00\x71\x90\x90\x90\x90\x90')
        self.assertEqual(msg, expected)
    ...
    def test_generate_dnload_CRM(self):
        ...
        expected = bytes('\xff\x00\x72\x02\x12\x34\x56\x78')
        self.assertEqual(msg, expected)
    ...
    def test_generate_program_CRM(self):
        ...
        expected = bytes('\xff\x00\x73\x02\x12\x34\x56\x78')
        self.assertEqual(msg, expected)
    ...
    def test_generate_upload_CRM(self):
        ...
        expected = bytes('\xff\x00\x74\xde\xad\xbe\xef\x90')
        self.assertEqual(msg, expected)
    ...
    def test_generate_clear_memory_CRM(self):
        ...
        expected = bytes('\xff\x00\x75\x90\x90\x90\x90\x90')
        self.assertEqual(msg, expected)
    ...
    def test_generate_move_CRM(self):
        ...
        expected = bytes('\xff\x00\x76\x90\x90\x90\x90\x90')
        self.assertEqual(msg, expected)
    ...
    def test_generate_test_CRM(self):
        ...
        expected = bytes('\xff\x00\x77\x90\x90\x90\x90\x90')
        self.assertEqual(msg, expected)
    ...
    def test_generate_exchangeID_CRM(self):
        ...
        expected = bytes('\xff\x00\x78\x04\x02\x02\x01\x90')
        self.assertEqual(msg, expected)
    ...
    def test_generate_ccp_version_CRM(self):
        ...
        expected = bytes('\xff\x00\x79\x02\x01\x90\x90\x90')
        self.assertEqual(msg, expected)
    ...
    def test_generate_get_seed_CRM(self):
        ...
        expected = bytes('\xff\x00\x80\x01\xde\xad\xbe\xef')
        self.assertEqual(msg, expected)
    ...
    def test_generate_build_chksum_CRM(self):
        ...
        expected = bytes('\xff\x00\x81\x04\xde\xad\xbe\xef')
        self.assertEqual(msg, expected)
    ...
    def test_generate_unlock_CRM(self):
        ...
        expected = bytes('\xff\x00\x82\x03\x90\x90\x90\x90')
        self.assertEqual(msg, expected)
    ...
    def test_generate_set_s_status_CRM(self):
        ...
        expected = bytes('\xff\x00\x83\x90\x90\x90\x90\x90')
        self.assertEqual(msg, expected)
    ...
    def test_generate_get_s_status_CRM(self):
        ...
        expected = bytes('\xff\x00\x84\x99\x01\x90\x90\x90')
        self.assertEqual(msg, expected)
